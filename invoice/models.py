...
class Client(models.Model):
    ...
    town = models.CharField(choices=TOWNS, blank=True, max_length=100)
    ...
    def __str__(self):
        return '{} {} {}'.format(self.clientName, self.town, self.uniqueId)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.uniqueId is None:
            ...
            self.slug = slugify('{} {} {}'.format(self.clientName, self.town, self.uniqueId))
