# Generated by Django 4.1.5 on 2023-01-04 16:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town', models.CharField(blank=True, choices=[('Bedok', 'Bedok'), ('Tangjong Pagar', 'Tangjong Pagar'), ('Jurong', 'Jurong')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('SGD', 'Singapore Dollar'), ('USD', 'US Dollar'), ('RMB', 'Chinese Yuan'), ('YEN', 'Japanese Yen'), ('WON', 'Korean WON'), ('EUR', 'Euro'), ('MYR', 'Malaysian Ringgit')], default='R', max_length=100)),
                ('uniqueId', models.CharField(blank=True, max_length=100, null=True)),
                ('slug', models.SlugField(blank=True, max_length=500, null=True, unique=True)),
                ('date_created', models.DateTimeField(blank=True, null=True)),
                ('last_updated', models.DateTimeField(blank=True, null=True)),
